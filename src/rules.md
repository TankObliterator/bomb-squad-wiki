...
## General (Discord)
These rules can also be found [here](https://discord.com/channels/1315632863437131819/1326501178661535785){target="_blank"}
1. Do not harass or threaten other members.
2. Do not post explicit, illegal, or harmful messages, attachments, or links.
3. Do not be a nuisance or spam in abundance.
4. Do not share other members' personal info without their permission.
5. Follow Discord TOS.
6. No scamming or advertising (business or other servers).
...
4. Content obtained directly from [Modrinth](https://modrinth.com/){target="_blank"} is exempt from the previous rule.
